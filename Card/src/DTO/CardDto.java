...
public class CardDto {
	...
	private String card_category; // 카드 카테고리
	private String card_benefit; // 카드 혜택
	
	public CardDto(String card_name, String card_company, int membership_fee, String images, String bank_link,
			String card_category, String card_benefit) {
		...
		this.card_benefit = card_benefit;
	}
	...
	public String getCard_benefit() {
		return card_benefit;
	}

	public void setCard_benefit(String card_benefit) {
		this.card_benefit = card_benefit;
	}
